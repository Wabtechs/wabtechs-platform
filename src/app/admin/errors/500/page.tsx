        ...
        <Card className="border-border bg-card">
          <CardContent className="flex flex-col items-center p-8 text-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#842ae3]/10">
              <AlertTriangle className="h-7 w-7 text-[#842ae3]" />
            </div>
            ...
            <div className="mt-6 flex items-center gap-3">
              <Button
                ...
                className="h-9 bg-primary text-white shadow-sm shadow-[#842ae3]/20 hover:bg-[#7323c4] hover:shadow-md hover:shadow-[#842ae3]/25"
              >
                Réessayer
              </Button>
              <Button asChild variant="outline" className="h-9 border-gray-200/80 dark:border-border">
