  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/admin/skills", {
        ...
        body: JSON.stringify({ ...form, percent: Number(form.percent), order: Number(form.order) }),
      });
  ...
  return (
    <div className="pt-24 pb-16">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-foreground">Nouvelle compétence</h1>
