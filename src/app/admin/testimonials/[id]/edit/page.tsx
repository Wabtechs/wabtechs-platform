...
export default function EditTestimonialPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    fetch(`/api/admin/testimonials`)
      .then((r) => r.json())
      .then((testimonials: TestimonialData[]) => {
  ...
  return (
    <div>
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-foreground">Modifier le témoignage</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <Card className="border-border bg-card">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label className="text-gray-900 dark:text-foreground">Rôle</Label>
                <Input
                  value={form.role}
              ...
              <div className="space-y-2">
                <Label className="text-gray-900 dark:text-foreground">Texte</Label>
                <Textarea
                  value={form.text}
