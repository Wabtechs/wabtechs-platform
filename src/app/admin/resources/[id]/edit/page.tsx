  ...
  return (
    <div className="pt-24 pb-16">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-foreground">Modifier la ressource</h1>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="article, vidéo, documentation, outil..."
                  className="border-gray-200 bg-gray-50 text-gray-900 dark:border-border dark:bg-muted dark:text-foreground"
                  required
                />
              </div>
