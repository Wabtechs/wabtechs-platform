...
export default function NewDownloadPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) router.push("/admin/downloads");
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div>
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-foreground">Nouveau téléchargement</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <Card className="border-border bg-card">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label className="text-gray-900 dark:text-foreground">URL du fichier</Label>
                <Input
                  value={form.fileUrl}
              ...
              <div className="space-y-2">
                <Label className="text-gray-900 dark:text-foreground">Taille du fichier (octets)</Label>
                <Input
                  type="number"
                  value={form.fileSize}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="outils, templates, ebooks..."
                  className="border-gray-200 bg-gray-50 text-gray-900 dark:border-border dark:bg-muted dark:text-foreground"
                  required
                />
              </div>
          ...
          <Button type="submit" disabled={loading} className="bg-primary text-white hover:bg-[#7323c4]">
            ...
            {loading ? "Création..." : "Créer le téléchargement"}
          </Button>
        </form>
      </div>
    </div>
