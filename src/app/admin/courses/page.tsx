        ...
        {items.length === 0 ? (
          <Card className="border-border bg-card">
            <CardContent className="flex flex-col items-center justify-center py-16">
              <GraduationCap className="mb-3 h-8 w-8 text-gray-300 dark:text-gray-600" />
            ...
            >
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-1.5 flex items-center gap-2 text-[12px] text-gray-400">
                  ...
                  <span>·</span>
                  <span>{item._count.lessons} leçons</span>
                  <span>·</span>
                  <span>{item._count.enrollments} inscriptions</span>
                </div>
              </div>
